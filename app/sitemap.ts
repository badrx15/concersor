...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${siteConfig.url}/conversores`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    ...
    { url: `${siteConfig.url}/contacto`, lastModified: now, changeFrequency: 'yearly', priority: 0.3 },
  ];
